...
--
-- Hôte : db
-- Généré le :  Dim 29 déc. 2019 à 19:47
...
CREATE TABLE `users` (
  ...
  `mail` int(10) NOT NULL DEFAULT '1',
...
--
ALTER TABLE `likes`
  MODIFY `like_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT pour la table `pictures`
--
ALTER TABLE `pictures`
  MODIFY `picture_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
